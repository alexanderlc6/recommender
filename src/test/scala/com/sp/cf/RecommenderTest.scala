...
import org.apache.mahout.cf.taste.impl.recommender.knn.{KnnItemBasedRecommender, NonNegativeQuadraticOptimizer}
...
import org.apache.mahout.cf.taste.impl.recommender.{GenericBooleanPrefUserBasedRecommender, GenericItemBasedRecommender, GenericUserBasedRecommender}
import org.apache.mahout.cf.taste.impl.similarity.{EuclideanDistanceSimilarity, LogLikelihoodSimilarity, PearsonCorrelationSimilarity, TanimotoCoefficientSimilarity}
...
class RecommenderIntroTests {
  ...
  @Test def intro() = {
    val model = new FileDataModel(new File("E:\\迅雷下载\\ml-10m\\ml-10M100K\\ratings.dat"))
...
//    }
  ...
  @Test def evaluateWithBooleanDataModel() = {
    ...
    val model = new GenericBooleanPrefDataModel(
      ...
      new FileDataModel(new File("E:\\迅雷下载\\ml-10m\\ml-10M100K\\ratings.dat"))))
    val evaluator = new AverageAbsoluteDifferenceRecommenderEvaluator()
